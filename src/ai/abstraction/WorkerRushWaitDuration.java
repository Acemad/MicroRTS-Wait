 ...
 * @author santi
 */
public class WorkerRushWaitDuration extends AbstractionLayerWaitDurationAI {
    Random r = new Random();
    ...
    public WorkerRushWaitDuration(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding(), 10);
    }

    public WorkerRushWaitDuration(UnitTypeTable a_utt, int waitDuration) {
        this(a_utt, new AStarPathFinding(), waitDuration);
    }

    public WorkerRushWaitDuration(UnitTypeTable a_utt, PathFinding a_pf, int waitDuration) {
    ...
    public AI clone() {
        return new WorkerRushWaitDuration(utt, pf, waitDuration);
    }
