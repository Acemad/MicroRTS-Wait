...
import ai.abstraction.WorkerRushWaitDuration;
 ...
 * @author santi
 */
public class POWorkerRushWaitDuration extends WorkerRushWaitDuration {

    public POWorkerRushWaitDuration(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding(),10);
    }

    public POWorkerRushWaitDuration(UnitTypeTable a_utt, int waitDuration) {
        this(a_utt, new AStarPathFinding(), waitDuration);
    }

    public POWorkerRushWaitDuration(UnitTypeTable a_utt, PathFinding a_pf, int waitDuration) {
    ...
    public AI clone() {
        return new POWorkerRushWaitDuration(utt, pf, waitDuration);
    }
