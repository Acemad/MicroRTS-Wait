 ...
 * @author santi
 */
public abstract class AbstractionLayerWaitDurationAI extends AIWithComputationBudget {
    ...
    protected int waitDuration = 10;

    public AbstractionLayerWaitDurationAI(PathFinding a_pf) {
        super(-1, -1);
        pf = a_pf;
    }

    public AbstractionLayerWaitDurationAI(PathFinding a_pf, int waitDuration) {
        super(-1, -1);
        pf = a_pf;
        this.waitDuration = waitDuration;
    }

    public AbstractionLayerWaitDurationAI(PathFinding a_pf, int timebudget, int cyclesbudget) {
    ...
    public PlayerAction translateActions(int player, GameState gs) {        
        ...
        pa.fillWithNones(gs, player, waitDuration);
        return pa;
    }
